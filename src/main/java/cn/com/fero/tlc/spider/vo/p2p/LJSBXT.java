...
public class LJSBXT {
    ...
    public boolean equals(Object o) {
        ...
        LJSBXT ljsbxt = (LJSBXT) o;

        if (adjustPrice != null ? !adjustPrice.equals(ljsbxt.adjustPrice) : ljsbxt.adjustPrice != null) return false;
        if (buyerTransactionFee != null ? !buyerTransactionFee.equals(ljsbxt.buyerTransactionFee) : ljsbxt.buyerTransactionFee != null)
            return false;
        if (canWithHold != null ? !canWithHold.equals(ljsbxt.canWithHold) : ljsbxt.canWithHold != null) return false;
        if (code != null ? !code.equals(ljsbxt.code) : ljsbxt.code != null) return false;
        if (collectionModeDisplay != null ? !collectionModeDisplay.equals(ljsbxt.collectionModeDisplay) : ljsbxt.collectionModeDisplay != null)
            return false;
        if (countDownSeconds != null ? !countDownSeconds.equals(ljsbxt.countDownSeconds) : ljsbxt.countDownSeconds != null)
            return false;
        if (displayName != null ? !displayName.equals(ljsbxt.displayName) : ljsbxt.displayName != null) return false;
        if (doneCountDownSeconds != null ? !doneCountDownSeconds.equals(ljsbxt.doneCountDownSeconds) : ljsbxt.doneCountDownSeconds != null)
            return false;
        if (increaseInvestAmount != null ? !increaseInvestAmount.equals(ljsbxt.increaseInvestAmount) : ljsbxt.increaseInvestAmount != null)
            return false;
        if (interestRateDisplay != null ? !interestRateDisplay.equals(ljsbxt.interestRateDisplay) : ljsbxt.interestRateDisplay != null)
            return false;
        ...
        if (lastUpdateTime != null ? !lastUpdateTime.equals(ljsbxt.lastUpdateTime) : ljsbxt.lastUpdateTime != null)
            return false;
        if (maxInvestAmount != null ? !maxInvestAmount.equals(ljsbxt.maxInvestAmount) : ljsbxt.maxInvestAmount != null)
            return false;
        if (minInterestRate != null ? !minInterestRate.equals(ljsbxt.minInterestRate) : ljsbxt.minInterestRate != null)
            return false;
        if (minInvestAmount != null ? !minInvestAmount.equals(ljsbxt.minInvestAmount) : ljsbxt.minInvestAmount != null)
            return false;
        if (numberOfInstalments != null ? !numberOfInstalments.equals(ljsbxt.numberOfInstalments) : ljsbxt.numberOfInstalments != null)
            return false;
        if (price != null ? !price.equals(ljsbxt.price) : ljsbxt.price != null) return false;
        if (priceAdjustmentFlag != null ? !priceAdjustmentFlag.equals(ljsbxt.priceAdjustmentFlag) : ljsbxt.priceAdjustmentFlag != null)
            return false;
        if (principal != null ? !principal.equals(ljsbxt.principal) : ljsbxt.principal != null) return false;
        if (productCategory != null ? !productCategory.equals(ljsbxt.productCategory) : ljsbxt.productCategory != null)
            return false;
        if (productId != null ? !productId.equals(ljsbxt.productId) : ljsbxt.productId != null) return false;
        if (productStatus != null ? !productStatus.equals(ljsbxt.productStatus) : ljsbxt.productStatus != null)
            return false;
        if (productType != null ? !productType.equals(ljsbxt.productType) : ljsbxt.productType != null) return false;
        if (progress != null ? !progress.equals(ljsbxt.progress) : ljsbxt.progress != null) return false;
        if (publishedAt != null ? !publishedAt.equals(ljsbxt.publishedAt) : ljsbxt.publishedAt != null) return false;
        if (publishedAtDateTime != null ? !publishedAtDateTime.equals(ljsbxt.publishedAtDateTime) : ljsbxt.publishedAtDateTime != null)
            return false;
        if (raisedAmount != null ? !raisedAmount.equals(ljsbxt.raisedAmount) : ljsbxt.raisedAmount != null)
            return false;
        if (reducePrice != null ? !reducePrice.equals(ljsbxt.reducePrice) : ljsbxt.reducePrice != null) return false;
        if (remainingAmount != null ? !remainingAmount.equals(ljsbxt.remainingAmount) : ljsbxt.remainingAmount != null)
            return false;
        if (remainingSeconds != null ? !remainingSeconds.equals(ljsbxt.remainingSeconds) : ljsbxt.remainingSeconds != null)
            return false;
        if (riskLevel != null ? !riskLevel.equals(ljsbxt.riskLevel) : ljsbxt.riskLevel != null) return false;
        if (riskLevelDisplay != null ? !riskLevelDisplay.equals(ljsbxt.riskLevelDisplay) : ljsbxt.riskLevelDisplay != null)
            return false;
        if (salesChannel != null ? !salesChannel.equals(ljsbxt.salesChannel) : ljsbxt.salesChannel != null)
            return false;
        if (sourceType != null ? !sourceType.equals(ljsbxt.sourceType) : ljsbxt.sourceType != null) return false;
        if (tradingMode != null ? !tradingMode.equals(ljsbxt.tradingMode) : ljsbxt.tradingMode != null) return false;
