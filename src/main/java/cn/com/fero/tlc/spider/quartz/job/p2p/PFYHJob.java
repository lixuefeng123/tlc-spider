...
public class PFYHJob extends TLCSpiderJob {
    ...
    private static final String URL_PRODUCT_LIST = PropertiesUtil.getResource("tlc.spider.pfyh.url.list");
    private static final String SID = PropertiesUtil.getResource("tlc.spider.pfyh.sid");
    private static final String TOKEN = PropertiesUtil.getResource("tlc.spider.pfyh.token");
    private static final String JOB_TITLE = PropertiesUtil.getResource("tlc.spider.pfyh.title");
