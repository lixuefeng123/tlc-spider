...
public class QDYHCFEW {
    ...
    private String f_Financing_InitId;
    ...
    public String getF_Financing_InitId() {
        return f_Financing_InitId;
    }

    public void setF_Financing_InitId(String f_Financing_InitId) {
        this.f_Financing_InitId = f_Financing_InitId;
    }
    ...
    public boolean equals(Object o) {
        ...
        QDYHCFEW qdyhcfew = (QDYHCFEW) o;

        if (agreementType != null ? !agreementType.equals(qdyhcfew.agreementType) : qdyhcfew.agreementType != null)
            return false;
        if (amount != null ? !amount.equals(qdyhcfew.amount) : qdyhcfew.amount != null) return false;
        if (areaCode != null ? !areaCode.equals(qdyhcfew.areaCode) : qdyhcfew.areaCode != null) return false;
        if (bankInterest != null ? !bankInterest.equals(qdyhcfew.bankInterest) : qdyhcfew.bankInterest != null)
            return false;
        if (bindCompanyId != null ? !bindCompanyId.equals(qdyhcfew.bindCompanyId) : qdyhcfew.bindCompanyId != null)
            return false;
        if (bindCompanyName != null ? !bindCompanyName.equals(qdyhcfew.bindCompanyName) : qdyhcfew.bindCompanyName != null)
            return false;
        ...
        if (createCompanyName != null ? !createCompanyName.equals(qdyhcfew.createCompanyName) : qdyhcfew.createCompanyName != null)
            return false;
        if (createTime != null ? !createTime.equals(qdyhcfew.createTime) : qdyhcfew.createTime != null) return false;
        if (createUserId != null ? !createUserId.equals(qdyhcfew.createUserId) : qdyhcfew.createUserId != null)
            return false;
        if (createUserName != null ? !createUserName.equals(qdyhcfew.createUserName) : qdyhcfew.createUserName != null)
            return false;
        if (creditLevel != null ? !creditLevel.equals(qdyhcfew.creditLevel) : qdyhcfew.creditLevel != null)
            return false;
        if (duration != null ? !duration.equals(qdyhcfew.duration) : qdyhcfew.duration != null) return false;
        if (exclusiveCode != null ? !exclusiveCode.equals(qdyhcfew.exclusiveCode) : qdyhcfew.exclusiveCode != null)
            return false;
        if (f_Financing_InitId != null ? !f_Financing_InitId.equals(qdyhcfew.f_Financing_InitId) : qdyhcfew.f_Financing_InitId != null)
            return false;
        if (financeApplyStatus != null ? !financeApplyStatus.equals(qdyhcfew.financeApplyStatus) : qdyhcfew.financeApplyStatus != null)
            return false;
        if (financingId != null ? !financingId.equals(qdyhcfew.financingId) : qdyhcfew.financingId != null)
            return false;
        if (hotStatus != null ? !hotStatus.equals(qdyhcfew.hotStatus) : qdyhcfew.hotStatus != null) return false;
        if (iAmount != null ? !iAmount.equals(qdyhcfew.iAmount) : qdyhcfew.iAmount != null) return false;
        if (iCount != null ? !iCount.equals(qdyhcfew.iCount) : qdyhcfew.iCount != null) return false;
        if (investmentInterest != null ? !investmentInterest.equals(qdyhcfew.investmentInterest) : qdyhcfew.investmentInterest != null)
            return false;
        if (isExclusivePublic != null ? !isExclusivePublic.equals(qdyhcfew.isExclusivePublic) : qdyhcfew.isExclusivePublic != null)
            return false;
        if (isShow != null ? !isShow.equals(qdyhcfew.isShow) : qdyhcfew.isShow != null) return false;
        if (isVIP != null ? !isVIP.equals(qdyhcfew.isVIP) : qdyhcfew.isVIP != null) return false;
        if (jMBeginTime != null ? !jMBeginTime.equals(qdyhcfew.jMBeginTime) : qdyhcfew.jMBeginTime != null)
            return false;
        if (lCAmount != null ? !lCAmount.equals(qdyhcfew.lCAmount) : qdyhcfew.lCAmount != null) return false;
        if (minInvestPartsCount != null ? !minInvestPartsCount.equals(qdyhcfew.minInvestPartsCount) : qdyhcfew.minInvestPartsCount != null)
            return false;
        if (partsCount != null ? !partsCount.equals(qdyhcfew.partsCount) : qdyhcfew.partsCount != null) return false;
        if (progress != null ? !progress.equals(qdyhcfew.progress) : qdyhcfew.progress != null) return false;
        if (projectBeginTime != null ? !projectBeginTime.equals(qdyhcfew.projectBeginTime) : qdyhcfew.projectBeginTime != null)
            return false;
        if (projectCode != null ? !projectCode.equals(qdyhcfew.projectCode) : qdyhcfew.projectCode != null)
            return false;
        if (projectName != null ? !projectName.equals(qdyhcfew.projectName) : qdyhcfew.projectName != null)
            return false;
        if (projectStatus != null ? !projectStatus.equals(qdyhcfew.projectStatus) : qdyhcfew.projectStatus != null)
            return false;
        if (projectType != null ? !projectType.equals(qdyhcfew.projectType) : qdyhcfew.projectType != null)
            return false;
        if (readyBeginTime != null ? !readyBeginTime.equals(qdyhcfew.readyBeginTime) : qdyhcfew.readyBeginTime != null)
            return false;
        if (realProgress != null ? !realProgress.equals(qdyhcfew.realProgress) : qdyhcfew.realProgress != null)
            return false;
        if (remainPartsCount != null ? !remainPartsCount.equals(qdyhcfew.remainPartsCount) : qdyhcfew.remainPartsCount != null)
            return false;
        if (repayBegin != null ? !repayBegin.equals(qdyhcfew.repayBegin) : qdyhcfew.repayBegin != null) return false;
        if (repaySourceType != null ? !repaySourceType.equals(qdyhcfew.repaySourceType) : qdyhcfew.repaySourceType != null)
            return false;
        if (repayType != null ? !repayType.equals(qdyhcfew.repayType) : qdyhcfew.repayType != null) return false;
        if (settlementType != null ? !settlementType.equals(qdyhcfew.settlementType) : qdyhcfew.settlementType != null)
            return false;
        if (title != null ? !title.equals(qdyhcfew.title) : qdyhcfew.title != null) return false;
        if (toInvestmentTime != null ? !toInvestmentTime.equals(qdyhcfew.toInvestmentTime) : qdyhcfew.toInvestmentTime != null)
            return false;
        if (updateTime != null ? !updateTime.equals(qdyhcfew.updateTime) : qdyhcfew.updateTime != null) return false;
        if (updateUserId != null ? !updateUserId.equals(qdyhcfew.updateUserId) : qdyhcfew.updateUserId != null)
            return false;
        if (valueBegin != null ? !valueBegin.equals(qdyhcfew.valueBegin) : qdyhcfew.valueBegin != null) return false;
        if (yMInterest != null ? !yMInterest.equals(qdyhcfew.yMInterest) : qdyhcfew.yMInterest != null) return false;
    ...
    @Override
    public int hashCode() {
        int result = agreementType != null ? agreementType.hashCode() : 0;
        ...
        result = 31 * result + (f_Financing_InitId != null ? f_Financing_InitId.hashCode() : 0);
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("QDYHCFEW{");
        ...
        sb.append(", f_Financing_InitId='").append(f_Financing_InitId).append('\'');
